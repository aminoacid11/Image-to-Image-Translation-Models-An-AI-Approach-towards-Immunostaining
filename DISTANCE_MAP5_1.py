...
for i in range(1, number_of_images+1):
    original_image = io.imread(os.path.join(real_path, f"real_{i}.png"))
    real_image = img_as_float(color.rgb2gray(original_image))
...
for i, (real_image, synthetic_image) in enumerate(image_pairs):
    ...
    # Color the closer part of the images as red and dissimilar part as blue
